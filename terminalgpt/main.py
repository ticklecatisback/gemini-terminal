...
@click.option('--model', '-m', type=click.Choice(['gemini-1.0-pro', 'gemini-1.0-pro-vision', 'gemini-1.5-pro-latest'], case_sensitive=False),
              default='gemini-1.0-pro', show_default=True, help='Choose a model to use.')
...
def delete(ctx):
    ...
    click.echo("Deleting conversation...")
    printer: Printer = PrinterFactory.get_printer("plain")
